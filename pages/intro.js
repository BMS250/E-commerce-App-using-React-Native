        ...
        <View style={{gap: 18, marginHorizontal: 18}}>
            ...
            {imgNum < 3 ?
                <View style={{gap: 18}}>
                    ...
                    <TouchableOpacity style={{ margin: "auto", fontWeight: 600 }} onPress={() => navigation.navigate('Food')}><Text>SKIP</Text></TouchableOpacity>
                </View>
                : <TouchableOpacity style={{ backgroundColor: "#FF7622", padding: 12, borderRadius: 12 }} onPress={() => navigation.navigate('Food')}><Text style={{ margin: "auto", color: "white", fontWeight: 600 }}>GET STARTED</Text></TouchableOpacity>
            }
